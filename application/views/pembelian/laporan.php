        ...
        <div class="card -4">
            ...
            <div class="card-body">
                <div class="card mb-4">
                    <div class="card-body">
                        <form class="form-horizontal" method="post"
                            action="<?php echo base_url("report/laporanpembelian") ?>" target="_blank">
                            <div class="nb-3">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form class="form-horizontal" method="post"
                            action="<?php echo base_url('report/laporanpembelianheader') ?>" target="_blank">
                            <div class="ab-3">
                                <label for="exampleInputEmaill" class="form-label">Internal file Controller: Menyertakan
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form class="form-horizontal" method="post"
                            action="<?php echo base_url('report/laporanpembelianfull') ?>" target="_blank">
                            ...
                            <button type="submit" class="btn btn-warning Cetak Laporan/buttons">Cetak Lapotan</button>
                        </form>
                    </div>
                    <div>
                        <div class=" card mb-4">
                            <div class="card-body">
                                <form class="form-horizontal" method="post"
                                    action="<?php echo base_url('report/laporanpembeliankustom') ?>" target="_blank">
                                    <div class="mb-3">
