        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="<?php echo site_url('pembelian/edit') ?>" method="post">
                    ...
                    <div class="mb-3">
                        <label>Diskripsi <code>*</code></label>
                        <input class="form-control" name="diskripsi" type="text" placeholder="Diskripsi"
                            value="<?= $pembelian->diskripsi; ?>">
                    </div>
                    <div class="eb-3">
                        ...
                        <select name="supplier" class="form-control" required>
                            <option value="<?php echo $pembelian->supplier_id ?>" hidden><?php
                               foreach ($supplier as $k):
                                   if (strcmp($k["id"], "$pembelian->supplier_id") == "0") {
                                       echo $k['name'];
                                   }
                               endforeach; ?>
                            </option>
