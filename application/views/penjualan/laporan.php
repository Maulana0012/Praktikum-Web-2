        ...
        <div class="card -4">
            ...
            <div class="card-body">
                <div class="card mb-4">
                    <div class="card-body">
                        <form class="form-horizontal" method="post"
                            action="<?php echo base_url("report/laporanpenjualan") ?>" target="_blank">
                            <div class="nb-3">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form class="form-horizontal" method="post"
                            action="<?php echo base_url('report/laporanpenjualanheader') ?>" target="_blank">
                            <div class="ab-3">
                                <label for="exampleInputEmaill" class="form-label">Internal file Controller: Menyertakan
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form class="form-horizontal" method="post"
                            action="<?php echo base_url('report/laporanpenjualanfull') ?>" target="_blank">
                    ...
                    <div>
                        <div class=" card mb-4">
                            <div class="card-body">
                                <form class="form-horizontal" method="post"
                                    action="<?php echo base_url('report/laporanpenjualankustom') ?>" target="_blank">
                                    <div class="mb-3">
